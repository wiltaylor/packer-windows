...
if(-not(Test-Path 'c:\windows\temp\7z920-x64.msi'))
{
  $client.DownloadFile('http://www.7-zip.org/a/7z920-x64.msi', 'c:\windows\temp\7z920-x64.msi')
}

&"c:\windows\system32\msiexec.exe" /i 'c:\windows\temp\7z920-x64.msi' /qn REBOOT=ReallySupress | out-null
...
&"c:\windows\system32\msiexec.exe" /x 'c:\windows\temp\7z920-x64.msi' /qn | out-null
